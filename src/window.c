                                  ...
                                  bool shadow)
{
    ...
    if (window->shadow) {
        /* Add a shadow pixel map under the window with a shadow effect. */
        ...
        window->shadow_pixmap->window = window;
...
void twin_window_show(twin_window_t *window)
{
    if (window->shadow) {
        twin_pixmap_show(window->shadow_pixmap, window->screen,
                         window->screen->top);
        twin_pixmap_show(window->pixmap, window->screen, window->shadow_pixmap);
    } else if (window->pixmap != window->screen->top)
