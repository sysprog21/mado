...
static tvg_result_t tvg_document_dimensions(tvg_input_func_t inp,
                                            void *inp_state,
                                            uint32_t *out_width,
                                            uint32_t *out_height)
{
...
static tvg_result_t tvg_render_document(tvg_input_func_t inp,
                                        void *inp_state,
                                        twin_pixmap_t *pix)
{
    /* initialize the context */
...
twin_pixmap_t *_twin_tvg_to_pixmap(const char *filepath, twin_format_t fmt)
{
    ...
    res = tvg_render_document(inp_func, infile, pix);
    if (res != TVG_SUCCESS) {
